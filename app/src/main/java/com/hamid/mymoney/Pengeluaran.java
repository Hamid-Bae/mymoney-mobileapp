    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.pemasukan_menu:
                Intent pemasukan = new Intent(Pengeluaran.this, Pemasukan.class);
                startActivity(pemasukan);
                finish();
                //Toast.makeText(this, "On Going selected", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.pengeluaran_menu:
                Intent pengeluaran = new Intent(Pengeluaran.this, Pengeluaran.class);
                startActivity(pengeluaran);
                finish();
                //Toast.makeText(this, "Deadline selected", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.add_menu:
                Intent tambahtransaksi = new Intent(Pengeluaran.this, Tambah_Transaksi.class);
